...
void DirectorManager::initializeLuaEngine(Lua* luaEngine) {
	...
	//Ethan edit: Hondo Bazaar Bot additions:
	luaEngine->registerFunction("bazaarBotListItem", bazaarBotListItem);
	luaEngine->registerFunction("bazaarBotMakeCraftedItem", bazaarBotMakeCraftedItem);
	luaEngine->registerFunction("bazaarBotMakeLootItem", bazaarBotMakeLootItem);
	luaEngine->registerFunction("bazaarBotMakeResources", bazaarBotMakeResources);
	luaEngine->registerFunction("getRandomResource", getRandomResource);
...
//Ethan edit: Hondo stuff for bazaar bot:
